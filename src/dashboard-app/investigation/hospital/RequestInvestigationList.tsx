...
export interface RequestInvestigationListProps {
  userType?: UserType;
  listPageHook?: any;
...
const RequestInvestigationList: React.FC<RequestInvestigationListProps> = (props) => (
  <MainListView
    {...props}
    items={data}
    uniqueColumns={uniqueColumns}
    showRecordCreated={false}
    recordType="Request Investigation"
    actionFields="investigation"
    addButtonText="Investigation"
    investigationDropdown
  />
);

// const RequestInvestigationList: React.FC<RequestInvestigationListProps> = () => {
...
export default RequestInvestigationList;
