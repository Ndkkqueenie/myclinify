...
// ====================================================
// GraphQL query operation: GetSurgery
// ====================================================

export interface GetSurgery_surgery {
...
export interface GetSurgery {
  surgery: GetSurgery_surgery;
}

export interface GetSurgeryVariables {
  id: string;
}
