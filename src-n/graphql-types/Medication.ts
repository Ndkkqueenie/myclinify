...
export interface Medication_dispenseDetails_createdBy {
  __typename: "ProfileModel";
  fullName: string | null;
}

export interface Medication_dispenseDetails_updatedBy {
  __typename: "ProfileModel";
  fullName: string | null;
}

export interface Medication_dispenseDetails {
  ...
  createdDate: any;
  createdBy: Medication_dispenseDetails_createdBy;
  updatedDate: any;
  updatedBy: Medication_dispenseDetails_updatedBy | null;
}
...
export interface Medication {
  ...
  details: Medication_details[] | null;
  dispenseDetails: Medication_dispenseDetails[] | null;
